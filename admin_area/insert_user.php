               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="admin_pass" minlength=8 type="password" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="admin_contact" type="tel" pattern="[0][0-9]{9}"  minlength="10" maxlength="11" class="form-control" required>
...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (admin_name,admin_email,admin_pass,country_id,admin_contact,admin_job,admin_image,admin_about) values ('$user_name','$user_email','$user_pass','$country_id','$user_contact','$user_job','$user_image','$user_about')";
