      ...
      include("includes/sidebar.php");    
           ...
           <div class="col-md-9"><!--col-md-9 begin-->
               <div class="box"><!--box begin-->
                   <h1 aligne="center">Please Confirm Your Payment</h1>
                   <form action="confirm.php?update_id=<?php echo $order_id; ?>" method="post" enctype="multipart/form-data"> 
                      ...
                      <div class="form-group"><!--form-group- begin-->
                         ...
                         <input readonly type="text" class="form-control" name="amount_sent" value=  <?php echo $due_amount ?> required>
                      </div><!--form-group- finish-->
                      <div class="form-group"><!--form-group- begin-->
                      ...
                      <div class="form-group"><!--form-group- begin-->
                         ...
                         <input minlength="13" maxlength="13" type="text" class="form-control" name="ref_no" required>
                      </div><!--form-group- finish-->
                      <div class="form-group"><!--form-group- begin-->
                         <label> (Paysera / Paypall / Payoneer) Code :</label>
                         <input minlength="8" type="text" class="form-control" name="code" required>
                      </div><!--form-group- finish-->  
                                  
                      <div class="text-center"><!--text-center bein-->
                          <button class="btn btn-primary btn-lg" name="confirm_payment"><!--btn-primary btn-lg begin-->
                    ...
                    if(isset($_POST['confirm_payment'])){
                        ...
                        $code = $_POST['code'];
                        $complete = "paid";
                        $insert_payment ="insert into payments (order_id,payment_mode,ref_no,code,payment_date ) values ('$update_id','$payment_mode','$ref_no','$code',NOW())";
                        
                       if ($run_payment = mysqli_query($con,$insert_payment)){
                        ...
                        $update_pending_order = "update orders set order_status='$complete' where order_id='$update_id'";
                         $run_pending_order = mysqli_query($con,$update_pending_order);
                           ...
                           $msg = "Thanks for purchasing from our web site you can download your invoice from here -->http://localhost/B&R/customer/invoice.php?order_id=$update_id<--";
